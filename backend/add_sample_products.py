...
# Sample products based on your images
products = [
    {
    ...
    },
    {
        ...
        "price": 45000.00,
        "stock_quantity": 5,
        "image_url": "/images/crane-scale.jpg",
        "specifications": json.dumps({
    ...
    },
    {
        ...
        "price": 1800.00,
        "stock_quantity": 50,
        "image_url": "/images/mini-scale.jpg",
        "specifications": json.dumps({
            "capacity": "10/20kg",
    ...
    },
    {
        ...
        "price": 12500.00,
        "stock_quantity": 8,
        "image_url": "/images/chekar-platform.jpg",
        "specifications": json.dumps({
            "capacity": "500kg",
    ...
    {
        "name": "600x600mm Platform Scale 100/200/300/500kg",
        "category": "weighing_scale",
        ...
        "price": 15000.00,
        "stock_quantity": 12,
        "image_url": "/images/ss-platform-600.jpg",
        "specifications": json.dumps({
    ...
    },
    {
        ...
        "price": 35000.00,
        "stock_quantity": 3,
        "image_url": "/images/explosion-proof.jpg",
        "specifications": json.dumps({
...
def add_products():
    ...
    print(f"\n✨ Finished! Added {i} products to the database.")
    print("\nYou can view them at: http://127.0.0.1:8000/api/products/")
    print("Or visit the docs: http://127.0.0.1:8000/docs")
