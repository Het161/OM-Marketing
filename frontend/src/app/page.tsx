...
//       {/* Featured Products Section - WITH ANIMATED BACKGROUND */}
...
//       {/* Categories Section - WITH ANIMATED BACKGROUND */}
//       <section className="py-20 px-4 relative overflow-hidden">
//         {/* Gradient Background */}
...
//                 href: '/products?category=weighing_scale',
//               },
//               {
//                 name: 'Note Counters',
//                 icon: '💵',
...
//                 href: '/products?category=note_counter',
//               },
//               {
//                 name: 'Accessories',
//                 icon: '📱',
...
//                 href: '/products?category=mobile_accessory',
//               },
//             ].map((category, index) => (
//               <motion.div
//                 key={index}
...
//                       <motion.div
//                         whileHover={{ x: 5 }}
//                         className="text-primary-500 font-semibold flex items-center gap-2"
//                       >
//                         Browse →
//                       </motion.div>
//                     </div>
...
//                 whileHover={{ scale: 1.05, y: -2 }}
//                 whileTap={{ scale: 0.95 }}
//                 className="bg-gradient-to-r from-orange-500 to-amber-500 text-white px-10 py-4 rounded-2xl font-bold text-lg shadow-xl hover:shadow-2xl transition-all"
//               >
//                 View All Categories
//               </motion.button>
//             </Link>
...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen">
      ...
      {/* Browse by Category Section - NEW 3-CARD DESIGN */}
      <section className="py-20 px-4 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50" />
